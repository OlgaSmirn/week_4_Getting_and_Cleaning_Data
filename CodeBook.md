# Codebook of the project : Getting and Cleaning Data
...
## Output Data
File "AverageData.txt" --- contains tidy data set with the average of each variable for each activity and each subject.

### Subject 
- group of 30 volunteers who carried out the experiment Values: 1 to 30
...
### Variables
-79 variables containing average of each Mean or Std variable in source datasets, grouped by activity and subject.

## File Structure:
* subject                     : int  1 1 1 1 1 1 2 2 2 2 ...
* activity                     : Factor w/ 6 levels "LAYING","SITTING",..: 1 2 
* tBodyAcc_mean_X            : num  0.222 0.261 0.279 0.277 0.289 ...
* tBodyAcc_mean_Y            : num  -0.04051 -0.00131 -0.01614 -0.01738 -0. $
...
* tBodyAccJerk_mean_Y         : num  0.003838 -0.000619 0.007976 0.028272 0.02
* tBodyAccJerk_mean_Z         : num  0.01083 -0.00337 -0.00369 -0.
...
* fBodyAcc_mean_Y            : num  -0.86707 -0.94408 -0.97707 0.08971 
...
* nfBodyAccJerk_mean_Z        : num  -0.948 -0.986 -0.991 -0.469 -0.288 ...
...
* fBodyGyro_meanFreq_X       : num  -0.00355 0.18915 -0.12029 0.01478 -0.100 
* fBodyGyro_meanFreq_Y       : num  -0.0915 0.0631 -0.0447 -0.0658 0.0826 .. 
* fBodyGyro_meanFreq_Z       : num  0.010458 -0.029784 0.100608 0.000773 -0. 
...
* fBodyBodyGyroMag_meanFreq  : num  -0.139775 -0.000262 -0.028606 0.268844 0 
